...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.replicator.isaac.ogn.OgnOnRLFrameDatabase import OgnOnRLFrameDatabase
        ...
        test_node = og.Controller.node("/TestGraph/Template_omni_replicator_isaac_OgnOnRLFrame")
