...
class TestROS1RTXSensor(omni.kit.test.AsyncTestCase):
    ...
    async def test_rtx_lidar(self):
        ...
        self.assertGreaterEqual(self._scan_data.header.stamp.secs, 1)
        self.assertLess(self._scan_data.header.stamp.secs, system_time / 2.0)
        self.assertGreaterEqual(self._pcl_data.header.stamp.secs, 1)
        self.assertLess(self._pcl_data.header.stamp.secs, system_time / 2.0)
        ...
        self.assertGreaterEqual(self._pcl_data.header.stamp.secs, system_time)
        self.assertGreaterEqual(self._scan_data.header.stamp.secs, system_time)
