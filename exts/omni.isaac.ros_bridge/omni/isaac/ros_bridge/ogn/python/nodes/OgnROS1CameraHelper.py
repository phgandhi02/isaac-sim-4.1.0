...
class OgnROS1CameraHelper:
    @staticmethod
    def internal_state():
        return OgnROS1CameraHelperInternalState()
            ...
            with Usd.EditContext(stage, stage.GetSessionLayer()):
                ...
                try:
                    if sensor_type == "rgb":
                        ...
                        writer = rep.writers.get(db.per_instance_state.rv + f"ROS1{time_type}PublishPointCloud")
                        writer.initialize(
                            frameId=db.inputs.frameId,
                            nodeNamespace=db.inputs.nodeNamespace,
                            queueSize=db.inputs.queueSize,
                        ...
                        writer = rep.writers.get(f"ROS1{time_type}PublishInstanceSegmentation")
                        writer.initialize(
                            frameId=db.inputs.frameId,
                            nodeNamespace=db.inputs.nodeNamespace,
                            queueSize=db.inputs.queueSize,
                        ...
                        writer = rep.writers.get(f"ROS1{time_type}PublishSemanticSegmentation")
                        writer.initialize(
                            frameId=db.inputs.frameId,
                            nodeNamespace=db.inputs.nodeNamespace,
                            queueSize=db.inputs.queueSize,
                        ...
                        writer = rep.writers.get(f"ROS1{time_type}PublishBoundingBox2DTight")
                        writer.initialize(
                            frameId=db.inputs.frameId,
                            nodeNamespace=db.inputs.nodeNamespace,
                            queueSize=db.inputs.queueSize,
                        ...
                        writer = rep.writers.get(f"ROS1{time_type}PublishBoundingBox2DLoose")
                        writer.initialize(
                            frameId=db.inputs.frameId,
                            nodeNamespace=db.inputs.nodeNamespace,
                            queueSize=db.inputs.queueSize,
                        ...
                        writer = rep.writers.get(f"ROS1{time_type}PublishBoundingBox3D")
                        writer.initialize(
                            frameId=db.inputs.frameId,
                            nodeNamespace=db.inputs.nodeNamespace,
                            queueSize=db.inputs.queueSize,
                        ...
                        writer = rep.writers.get(f"ROS1{time_type}PublishCameraInfo")
                        writer.initialize(
                            frameId=db.inputs.frameId,
                            nodeNamespace=db.inputs.nodeNamespace,
                            queueSize=db.inputs.queueSize,
                    ...
                    if sensor_type in type_dict:
                        if db.inputs.enableSemanticLabels:
                            semantic_writer = rep.writers.get(
                                type_dict[sensor_type] + f"ROS1{time_type}PublishSemanticLabels"
                            )
