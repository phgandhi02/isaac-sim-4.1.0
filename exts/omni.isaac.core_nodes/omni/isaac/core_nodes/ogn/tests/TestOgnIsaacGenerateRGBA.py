...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.core_nodes.ogn.OgnIsaacGenerateRGBADatabase import OgnIsaacGenerateRGBADatabase
        ...
        test_node = og.Controller.node("/TestGraph/Template_omni_isaac_core_nodes_IsaacGenerateRGBA")
