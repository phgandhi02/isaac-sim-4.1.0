...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.core_nodes.ogn.OgnIsaacCreateViewportDatabase import OgnIsaacCreateViewportDatabase
        ...
        test_node = og.Controller.node("/TestGraph/Template_omni_isaac_core_nodes_IsaacCreateViewport")
