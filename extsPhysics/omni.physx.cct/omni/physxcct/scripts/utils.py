...
class CharacterController:
    ...
    def setup_controls(self, speed, flags=ControlFlag.DEFAULT, rebind=None):
        ...
        # NOTE: hacky, neccessary until we have a better way how to switch contexts
        # blocking zero gravity hotkey, too close to WASD
        def on_blocked(_):
            ...

        state.register_keyboard_action("CctBlockZeroGravityHotkey", KeyboardInput.X, 0, on_blocked)
