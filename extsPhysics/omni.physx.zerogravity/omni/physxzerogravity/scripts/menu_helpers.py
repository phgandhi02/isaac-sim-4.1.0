...
class MenuHelpers:
    ...
    def create_static_coll_menu(cls):
        ...
        for k, v in cls._static_coll_approximations.items():
            cls.create_settings_menu_item_int(v, ZeroGravitySettings.SETTINGS_STATIC_COLLIDER_SIMPLIFICATION_TYPE, k)
    ...
    def create_dynamic_coll_menu(cls):
        ...
        for k, v in cls._dynamic_coll_approximations.items():
            cls.create_settings_menu_item_int(v, ZeroGravitySettings.SETTINGS_DYNAMIC_COLLIDER_SIMPLIFICATION_TYPE, k)
