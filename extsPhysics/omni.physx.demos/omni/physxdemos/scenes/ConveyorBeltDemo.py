...
class ConveyorBeltDemo(demo.Base):
    ...
    def create(self, stage):
        ...
        cylinderPrim.CreateAttribute("refinementEnableOverride", Sdf.ValueTypeNames.Bool, True).Set(True)
        cylinderPrim.CreateAttribute("refinementLevel", Sdf.ValueTypeNames.Int, True).Set(2)
