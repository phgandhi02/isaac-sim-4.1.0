...
class FrankaNutBoltDemo(franka_helpers.FrankaDemoBase):
    ...
    def __init__(self):
        ...
        # setup asset paths:
        self.asset_paths = {
            "franka": demo.get_demo_asset_path("FrankaNutBolt/SubUSDs/Franka/franka_alt_fingers.usd"),
            "shop_table": demo.get_demo_asset_path("FrankaNutBolt/SubUSDs/Shop_Table/Shop_Table.usd"),
            "tooling_plate": demo.get_demo_asset_path("FrankaNutBolt/SubUSDs/Tooling_Plate/Tooling_Plate.usd"),
            "nut": demo.get_demo_asset_path("FrankaNutBolt/SubUSDs/Nut/M20_Nut_Tight_R256_Franka_SI_Sparse.usd"),
            "bolt": demo.get_demo_asset_path("FrankaNutBolt/SubUSDs/Bolt/M20_Bolt_Tight_R512_Franka_SI_Sparse.usd"),
            "vibra_table_top": demo.get_demo_asset_path(
                "FrankaNutBolt/SubUSDs/VibrationTable_Top/VibrationTable_Top.usd"
            ),
            "vibra_table_bot": demo.get_demo_asset_path(
                "FrankaNutBolt/SubUSDs/VibrationTable_Base/VibrationTable_Base.usd"
            ),
            "vibra_table_collision": demo.get_demo_asset_path("FrankaNutBolt/SubUSDs/VibrationTable_Top_collision.usd"),
            "vibra_table_clamps": demo.get_demo_asset_path("FrankaNutBolt/SubUSDs/Clamps/Clamps.usd"),
            "pipe": demo.get_demo_asset_path("FrankaNutBolt/SubUSDs/Pipe/Pipe.usd"),
        }
        self.demo_base_usd_url = demo.get_demo_asset_path("FrankaNutBolt/StagingNutBolt.usd")
