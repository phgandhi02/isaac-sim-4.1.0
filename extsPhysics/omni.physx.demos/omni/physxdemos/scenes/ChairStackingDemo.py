...
class ChairStackingDemo(demo.AsyncDemoBase):
    ...
    def __init__(self):
        ...
        self.asset_paths = {
            "chair": demo.get_demo_asset_path("ChairStacking/SubUSDs/Chair/Chair_Wire_R512_Sparse.usd"),
        }
        self.demo_base_usd_url = demo.get_demo_asset_path("ChairStacking/StagingChairStacking.usd")
    ...
    def create(self, stage, Num_Stacks, Num_Chairs):
        ...
        physxMaterialAPI.CreateImprovePatchFrictionAttr().Set(True)
