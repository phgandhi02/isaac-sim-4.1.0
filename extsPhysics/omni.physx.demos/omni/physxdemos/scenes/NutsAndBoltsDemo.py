...
class NutsAndBoltsDemo(demo.AsyncDemoBase):
    ...
    def __init__(self):
        ...
        self.asset_paths = {
            "nut": demo.get_demo_asset_path("NutsAndBolts/M20_Nut_Tight_R256_SI_Sparse.usd"),
            "bolt": demo.get_demo_asset_path("NutsAndBolts/M20_Bolt_Tight_R512_SI_Sparse.usd"),
        }
        self.demo_base_usd_url = demo.get_demo_asset_path("NutsAndBolts/base_stage_SI.usd")
