    ...
    for y in range(0, nb_y):
        for x in range(0, nb_x):
            ...
            if data[count] == 'S':
                ...
                # make the sphere high-quality render
                spherePrim.CreateAttribute("refinementEnableOverride", Sdf.ValueTypeNames.Bool, True).Set(True)
                spherePrim.CreateAttribute("refinementLevel", Sdf.ValueTypeNames.Int, True).Set(2)
