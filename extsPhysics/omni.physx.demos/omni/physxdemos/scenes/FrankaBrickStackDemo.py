...
class FrankaBrickStackDemo(franka_helpers.FrankaDemoBase):
    ...
    def __init__(self):
        ...
        self.asset_paths = {
            "franka": demo.get_demo_asset_path("FrankaBrickStack/SubUSDs/Franka/franka_alt_fingers.usd"),
            "table": demo.get_demo_asset_path("FrankaBrickStack/SubUSDs/Table_Rounded/Table_Rounded.usd"),
            "stool": demo.get_demo_asset_path("FrankaBrickStack/SubUSDs/Franka_Stool/Franka_Stool.usd"),
            "twoByTwo": demo.get_demo_asset_path("FrankaBrickStack/SubUSDs/TwoByTwoSI_Sparse.usd"),
            "twoByFour": demo.get_demo_asset_path("FrankaBrickStack/SubUSDs/TwoByFourSI_Sparse.usd"),
            "brickMaterials": demo.get_demo_asset_path("FrankaBrickStack/SubUSDs/BrickMaterials.usd"),
        }
        self.demo_base_usd_url = demo.get_demo_asset_path("FrankaBrickStack/StagingBrickStack.usd")
