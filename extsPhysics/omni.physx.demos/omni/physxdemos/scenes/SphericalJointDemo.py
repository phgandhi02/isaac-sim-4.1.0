...
class SphericalJointDemo(demo.Base):
    title = "Spherical joint"
    category = demo.Categories.JOINTS
    short_description = "Demo showing basic spherical joint usage"
    description = "Demo showing basic spherical joint usage."
    tags = ["Joints"]
    ...
    def create(self, stage):
        ...
        # spherical joint
        sphericalJoint = UsdPhysics.SphericalJoint.Define(stage, defaultPrimPath + "/sphericalJoint")
        ...
        sphericalJoint.CreateBody0Rel().SetTargets([defaultPrimPath + "/box0"])
        sphericalJoint.CreateBody1Rel().SetTargets([defaultPrimPath + "/box1"])

        sphericalJoint.CreateLocalPos0Attr().Set(Gf.Vec3f(0.0, 60.0, 0.0))
        sphericalJoint.CreateLocalRot0Attr().Set(Gf.Quatf(0, Gf.Vec3f(1, 0, 0)))

        sphericalJoint.CreateLocalPos1Attr().Set(Gf.Vec3f(0.0, -60.0, 0.0))
