...
class PhysicsMassViewportOverlay(PhysicsViewportOverlay):
    def __init__(self, main_viewport_overlay):
        ...
        self._usd_object_changed_new_frame_sub = None
    ...
    def _manage_usd_change_listener(self):
        if(self._usd_context and self._usd_context.get_stage() and
            ...
            if self._usd_object_changed_listener is None:
                ...
                rendering_event_stream = self._usd_context.get_rendering_event_stream()
                self._usd_object_changed_new_frame_sub = rendering_event_stream.create_subscription_to_push_by_type(
                    omni.usd.StageRenderingEventType.NEW_FRAME, self._usd_change_listener_on_new_frame)
        else:
    ...
    def _usd_change_listener_on_new_frame(self, event: carb.events.IEvent):
        ...
        timeline_playing = self._timeline.is_playing()
