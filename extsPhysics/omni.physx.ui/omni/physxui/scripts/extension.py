...
from .utils import backward_compat_callback, register_stage_update_node
...
class PhysxUIExtension(omni.ext.IExt):
    ...
    def on_startup(self):
        ...
        self.stage_update_node = register_stage_update_node("physxUI", on_update_fn=on_stage_update)
        ...
        self._stage_event_sub = events.create_subscription_to_pop(on_stage_event)
