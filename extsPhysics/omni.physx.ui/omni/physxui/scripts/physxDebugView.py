...
class PhysxDebugWindow(ui.Window):
    ...
    def _build_visualization_base_settings_ui(self):
        ...
        def build_inner():
            ...
            events = usd.get_context().get_stage_event_stream()
            self._subs.append(events.create_subscription_to_pop(on_stage_event))
    ...
    def _build_omnipvd_ui(self):
        ...
        if usd_context:
            ...
            if event_stream:
                self._stage_event_sub = event_stream.create_subscription_to_pop(on_stage_event_omnipvd_enable)
