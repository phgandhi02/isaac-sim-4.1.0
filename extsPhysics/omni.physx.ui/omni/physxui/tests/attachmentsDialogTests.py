...
class AttachmentsDialogTests(omni.kit.test.AsyncTestCase):
    ...
    async def test_compute_overlapped_paths_pairs(self):
        ...
        result = physxAttachmentsDialog.compute_overlapped_paths_pairs(self._stage, particlecloths, deformablebodies, deformablesurfaces, hair, rigids, overlap_tolerance)
