...
from .utils import Limits, generate_schema_primary_aliases
...
material_apis = [
    ...
    PhysxSchema.PhysxDeformableSurfaceMaterialAPI,
    PhysxSchema.PhysxPBDMaterialAPI,
    PhysxSchema.PhysxHairMaterialAPI
]

base_prims = [
    UsdPhysics.Scene,
    UsdPhysics.CollisionGroup,
    PhysxSchema.TetrahedralMesh,
    UsdGeom.Plane,
...
extension_api_map = {
    ...
    PhysxSchema.PhysxHairAPI: [PhysxSchema.PhysxCollisionAPI],
}
...
schema_aliases = generate_schema_primary_aliases()
...
components = {
    ...
    Component(
        ...
        lambda p: p.IsA(UsdShade.Material),
        "PhysxDeformableBodyMaterialAPI", "Deformable Body Material", PhysxSchema.PhysxDeformableBodyMaterialAPI
    ),
    ...
    Component(
        ...
        lambda p: p.IsA(UsdGeom.Mesh) and not pxb.hasconflictingapis_PhysxDeformableBodyAPI(p, True),
        "PhysxDeformableBodyAPI", "Deformable Body", PhysxSchema.PhysxDeformableBodyAPI
    ),
    ...
    Component(
        ...
        "PhysxAutoAttachmentAPI", "Compute Auto Attachment", PhysxSchema.PhysxAutoAttachmentAPI
    ),
    ...
    Component(
        ...
        lambda p: p.IsA(UsdGeom.Mesh) and not pxb.hasconflictingapis_PhysxParticleClothAPI(p, False),
        "PhysxParticleClothAPI", "Particle Cloth", PhysxSchema.PhysxParticleClothAPI
    ),
    ...
    PhysxSchema.PhysxHairMaterialAPI.__name__:
    Component(
        lambda p: p.HasAPI(PhysxSchema.PhysxHairMaterialAPI),
        lambda p: p.IsA(UsdShade.Material),
        "PhysxHairMaterialAPI", "Hair Material", PhysxSchema.PhysxHairMaterialAPI
    ),
}
...
for mad in multi_apply_data:
    for inst in mad.instances:
        ...
        components[f"{mad.schema.__name__}:{inst_name}"] = Component(
...
INFO_FLT_NONNEG_VEC = InfoData(Gf.Vec3f(0), Gf.Vec3f(Limits.FLT_MAX))
...
property_info = {
    ...
    "contactDistance": INFO_FLT_NONNEG,
...
property_sentinels = {
    ...
    "physxAutoAttachment:maxHairRoots": {"Not Limited": Limits.INT_MAX},
...
default_order_map = {
    ...
    PhysxSchema.TetrahedralMesh: ['indices'],
    UsdGeom.Plane: ['axis'],
    PhysxSchema.PhysxSceneAPI: ['physxScene:bounceThreshold', 'physxScene:frictionOffsetThreshold', 'physxScene:collisionSystem', 'physxScene:solverType', 'physxScene:broadphaseType', 'physxScene:frictionType', 'physxScene:enableCCD', 'physxScene:enableStabilization', 'physxScene:enableGPUDynamics', 'physxScene:enableEnhancedDeterminism', 'physxScene:enableExternalForcesEveryIteration', 'physxScene:enableResidualReporting','physxScene:gpuTempBufferCapacity', 'physxScene:gpuMaxRigidContactCount', 'physxScene:gpuMaxRigidPatchCount', 'physxScene:gpuHeapCapacity', 'physxScene:gpuFoundLostPairsCapacity', 'physxScene:gpuFoundLostAggregatePairsCapacity', 'physxScene:gpuTotalAggregatePairsCapacity', 'physxScene:gpuMaxSoftBodyContacts', 'physxScene:gpuMaxFEMClothContacts', 'physxScene:gpuMaxParticleContacts', 'physxScene:gpuMaxNumPartitions', 'physxScene:invertCollisionGroupFilter'],
    ...
    PhysxSchema.PhysxMaterialAPI: ['physxMaterial:frictionCombineMode', 'physxMaterial:restitutionCombineMode', 'physxMaterial:dampingCombineMode', 'physxMaterial:improvePatchFriction', 'physxMaterial:compliantContactAccelerationSpring', 'physxMaterial:compliantContactStiffness', 'physxMaterial:compliantContactDamping'],
    ...
    PhysxSchema.PhysxJointAPI: ['physxJoint:enableProjection', 'physxJoint:jointFriction', 'physxJoint:maxJointVelocity'],
    ...
    PhysxSchema.PhysxLimitAPI: ['restitution', 'bounceThreshold', 'stiffness', 'damping', 'contactDistance'],
    ...
    PhysxSchema.PhysxDeformableSurfaceMaterialAPI: ['physxDeformableSurfaceMaterial:density', 'physxDeformableSurfaceMaterial:thickness', 'physxDeformableSurfaceMaterial:dynamicFriction', 'physxDeformableSurfaceMaterial:youngsModulus', 'physxDeformableSurfaceMaterial:poissonsRatio'],
    ...
    PhysxSchema.PhysxMimicJointAPI: ['physxMimicJoint:referenceJoint', 'physxMimicJoint:referenceJointAxis', 'physxMimicJoint:gearing', 'physxMimicJoint:offset'],
}
