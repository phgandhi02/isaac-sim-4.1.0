...
def patch_refresh_cache_to_prim(p, lmt=100000):
    ...
    has_api(PhysxSchema.PhysxDeformableBodyAPI, schemas) or has_api(PhysxSchema.PhysxDeformableSurfaceAPI, schemas)
    canadd_filteredpairs = has_rigidbody_api or has_collision_api or has_api(UsdPhysics.ArticulationRootAPI, schemas) or has_api(PhysxSchema.PhysxDeformableBodyAPI, schemas) or has_api(PhysxSchema.PhysxDeformableSurfaceAPI, schemas) or p.IsA(PhysxSchema.PhysxParticleSystem)
    canadd_massapi = has_rigidbody_api or has_collision_api or has_api(PhysxSchema.PhysxDeformableBodyAPI, schemas) or has_api(PhysxSchema.PhysxDeformableSurfaceAPI, schemas) or has_api(PhysxSchema.PhysxParticleAPI, schemas)
