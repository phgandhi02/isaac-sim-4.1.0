...
class TfTokenAttributeModelWMetadata(TfTokenAttributeModel):
    def _get_allowed_tokens(self, attr):
        metadata = attr.GetMetadata("allowedTokens")
        return metadata if metadata else self._metadata["allowedTokens"]
