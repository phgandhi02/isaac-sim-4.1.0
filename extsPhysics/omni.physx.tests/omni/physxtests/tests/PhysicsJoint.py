...
from omni.physx.bindings._physx import SimulationEvent, SETTING_DISPLAY_JOINTS, SETTING_LOG_ROBOTICS
import omni.usd
...
class PhysicsJointTestMemoryStage(PhysicsMemoryStageBaseAsyncTestCase, ArticulationTestBase):
    ...
    @unittest.skip("https://nvidia-omniverse.atlassian.net/browse/OM-42711")
