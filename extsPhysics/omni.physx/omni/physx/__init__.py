from .bindings._physx import PhysX, PhysXUnitTests, PhysXVisualization, PhysXCooking, PhysXSceneQuery, IPhysxSimulation, IPhysxBenchmarks, IPhysxAttachment, IPhysxPropertyQuery, IPhysxReplicator, IPhysxStageUpdate, IPhysxStatistics
from .bindings._physx import acquire_physx_interface, acquire_physxunittests_interface, acquire_physx_visualization_interface, acquire_physx_scene_query_interface, acquire_physx_cooking_interface, acquire_physx_simulation_interface, acquire_physx_benchmarks_interface, acquire_physx_attachment_interface, acquire_physx_property_query_interface, acquire_physx_replicator_interface, acquire_physx_stage_update_interface, acquire_physx_statistics_interface
...
def get_physx_attachment_interface() -> IPhysxAttachment:
    return _get_interface(get_physx_attachment_interface, acquire_physx_attachment_interface)
