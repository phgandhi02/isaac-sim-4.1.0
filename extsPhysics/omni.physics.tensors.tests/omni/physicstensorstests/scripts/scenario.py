...
class Runner(ABC):
    ...
    def push_preference_settings(self):
        ...
        self.saved_backward_compatibility = settings.get_as_bool(physx_bindings.SETTING_BACKWARD_COMPATIBILITY)
        settings.set(physx_bindings.SETTING_BACKWARD_COMPATIBILITY, BackwardCompatMode.WARN)
    ...
    def pop_preference_settings(self):
        ...
        if hasattr(self, "saved_backward_compatibility"):
            settings.set(physx_bindings.SETTING_BACKWARD_COMPATIBILITY, self.saved_backward_compatibility)
